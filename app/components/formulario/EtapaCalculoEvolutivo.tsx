...
const PADRAO_TABLE: Record<string, { Pc: number; Ir: number; R: number }> = {
  // ─── Tabela ref_padrao ANTIGO — extraída diretamente da planilha Evolutivo ───
  // BARRACO
  'BARRACO | Padrão Rústico -': { Pc:0.06,   Ir:5,  R:0.2 },
  'BARRACO | Padrão Rústico':   { Pc:0.09,   Ir:5,  R:0.2 },
  'BARRACO | Padrão Rústico +': { Pc:0.12,   Ir:5,  R:0.2 },
  'BARRACO | Padrão Simples -': { Pc:0.132,  Ir:10, R:0.2 },
  'BARRACO | Padrão Simples':   { Pc:0.156,  Ir:10, R:0.2 },
  'BARRACO | Padrão Simples +': { Pc:0.18,   Ir:10, R:0.2 },
  // CASA
  'CASA | Padrão Rústico -':    { Pc:0.36,   Ir:60, R:0.2 },
  'CASA | Padrão Rústico':      { Pc:0.42,   Ir:60, R:0.2 },
  'CASA | Padrão Rústico +':    { Pc:0.48,   Ir:60, R:0.2 },
  'CASA | Padrão Proletário -': { Pc:0.492,  Ir:60, R:0.2 },
  'CASA | Padrão Proletário':   { Pc:0.576,  Ir:60, R:0.2 },
  'CASA | Padrão Proletário +': { Pc:0.66,   Ir:60, R:0.2 },
  'CASA | Padrão Econômico -':  { Pc:0.672,  Ir:70, R:0.2 },
  'CASA | Padrão Econômico':    { Pc:0.786,  Ir:70, R:0.2 },
  'CASA | Padrão Econômico +':  { Pc:0.849,  Ir:70, R:0.2 },
  'CASA | Padrão Simples -':    { Pc:0.912,  Ir:70, R:0.2 },
  'CASA | Padrão Simples':      { Pc:1.056,  Ir:70, R:0.2 },
  'CASA | Padrão Simples +':    { Pc:1.2,    Ir:70, R:0.2 },
  'CASA | Padrão Médio -':      { Pc:1.212,  Ir:70, R:0.2 },
  'CASA | Padrão Médio':        { Pc:1.386,  Ir:70, R:0.2 },
  'CASA | Padrão Médio +':      { Pc:1.56,   Ir:70, R:0.2 },
  'CASA | Padrão Superior -':   { Pc:1.776,  Ir:70, R:0.2 },
  'CASA | Padrão Superior':     { Pc:1.98,   Ir:70, R:0.2 },
  'CASA | Padrão Superior +':   { Pc:2.208,  Ir:70, R:0.2 },
  'CASA | Padrão Fino -':       { Pc:2.436,  Ir:60, R:0.2 },
  'CASA | Padrão Fino':         { Pc:2.88,   Ir:60, R:0.2 },
  'CASA | Padrão Fino +':       { Pc:3.108,  Ir:60, R:0.2 },
  'CASA | Padrão Luxo -':       { Pc:3.336,  Ir:60, R:0.2 },
  // GALPÃO
  'GALPÃO | Padrão Econômico -':  { Pc:0.24,  Ir:60, R:0.2 },
  'GALPÃO | Padrão Econômico':    { Pc:0.36,  Ir:60, R:0.2 },
  'GALPÃO | Padrão Econômico +':  { Pc:0.48,  Ir:60, R:0.2 },
  'GALPÃO | Padrão Simples -':    { Pc:0.492, Ir:60, R:0.2 },
  'GALPÃO | Padrão Simples':      { Pc:0.726, Ir:60, R:0.2 },
  'GALPÃO | Padrão Simples +':    { Pc:0.96,  Ir:60, R:0.2 },
  'GALPÃO | Padrão Médio -':      { Pc:0.972, Ir:80, R:0.2 },
  'GALPÃO | Padrão Médio':        { Pc:1.326, Ir:80, R:0.2 },
  'GALPÃO | Padrão Médio +':      { Pc:1.68,  Ir:80, R:0.2 },
  'GALPÃO | Padrão Superior -':   { Pc:2.4,   Ir:80, R:0.2 },
  // COBERTURA
  'COBERTURA | Padrão Simples -':  { Pc:0.06,  Ir:20, R:0.1 },
  'COBERTURA | Padrão Simples':    { Pc:0.12,  Ir:20, R:0.1 },
  'COBERTURA | Padrão Simples +':  { Pc:0.18,  Ir:20, R:0.1 },
  'COBERTURA | Padrão Médio -':    { Pc:0.192, Ir:20, R:0.1 },
  'COBERTURA | Padrão Médio':      { Pc:0.246, Ir:20, R:0.1 },
  'COBERTURA | Padrão Médio +':    { Pc:0.3,   Ir:20, R:0.1 },
  'COBERTURA | Padrão Superior -': { Pc:0.312, Ir:30, R:0.1 },
  'COBERTURA | Padrão Superior':   { Pc:0.456, Ir:30, R:0.1 },
  // ESCRITÓRIO
  'ESCRITÓRIO | Econômico -':       { Pc:0.6,   Ir:70, R:0.2 },
  'ESCRITÓRIO | Econômico':         { Pc:0.78,  Ir:70, R:0.2 },
  'ESCRITÓRIO | Econômico +':       { Pc:0.96,  Ir:70, R:0.2 },
  'ESCRITÓRIO | Simples s/ elev -': { Pc:0.972, Ir:70, R:0.2 },
  'ESCRITÓRIO | Simples s/ elev':   { Pc:1.206, Ir:70, R:0.2 },
  'ESCRITÓRIO | Simples s/ elev +': { Pc:1.44,  Ir:70, R:0.2 },
  'ESCRITÓRIO | Simples c/ elev -': { Pc:1.2,   Ir:70, R:0.2 },
  'ESCRITÓRIO | Simples c/ elev':   { Pc:1.41,  Ir:70, R:0.2 },
  'ESCRITÓRIO | Simples c/ elev +': { Pc:1.62,  Ir:70, R:0.2 },
  'ESCRITÓRIO | Médio s/ elev -':   { Pc:1.452, Ir:60, R:0.2 },
  'ESCRITÓRIO | Médio s/ elev':     { Pc:1.656, Ir:60, R:0.2 },
  'ESCRITÓRIO | Médio s/ elev +':   { Pc:1.86,  Ir:60, R:0.2 },
  'ESCRITÓRIO | Médio c/ elev -':   { Pc:1.632, Ir:60, R:0.2 },
  'ESCRITÓRIO | Médio c/ elev':     { Pc:1.836, Ir:60, R:0.2 },
  'ESCRITÓRIO | Médio c/ elev +':   { Pc:2.04,  Ir:60, R:0.2 },
  'ESCRITÓRIO | Superior s/ elev -':{ Pc:1.872, Ir:60, R:0.2 },
  'ESCRITÓRIO | Superior s/ elev':  { Pc:2.046, Ir:60, R:0.2 },
  'ESCRITÓRIO | Superior s/ elev +':{ Pc:2.22,  Ir:60, R:0.2 },
  'ESCRITÓRIO | Superior c/ elev -':{ Pc:2.052, Ir:60, R:0.2 },
  'ESCRITÓRIO | Superior c/ elev':  { Pc:2.286, Ir:60, R:0.2 },
  'ESCRITÓRIO | Superior c/ elev +':{ Pc:2.52,  Ir:60, R:0.2 },
  'ESCRITÓRIO | Fino -':            { Pc:2.532, Ir:60, R:0.2 },
  'ESCRITÓRIO | Fino':              { Pc:3.066, Ir:60, R:0.2 },
  'ESCRITÓRIO | Fino +':            { Pc:3.6,   Ir:60, R:0.2 },
  'ESCRITÓRIO | Luxo -':            { Pc:4.14,  Ir:60, R:0.2 },
  'ESCRITÓRIO | Luxo':              { Pc:4.68,  Ir:60, R:0.2 },
  // Outros
  'PISCINA':       { Pc:1.0, Ir:60, R:0.2 },
  'PAVIMENTAÇÃO':  { Pc:1.0, Ir:60, R:0.2 },
}
const PADRAO_GRUPOS = [
  { grupo: 'Barraco',    prefixos: ['BARRACO'] },
  { grupo: 'Casa',       prefixos: ['CASA'] },
  { grupo: 'Galpão',     prefixos: ['GALPÃO'] },
  { grupo: 'Cobertura',  prefixos: ['COBERTURA'] },
  { grupo: 'Escritório', prefixos: ['ESCRITÓRIO'] },
  { grupo: 'Outros',     prefixos: ['PISCINA', 'PAVIMENTAÇÃO'] },
]
                    ...
                    <div className="col-span-2">
                      ...
                      <input className={inp} value={e.coordenadas}
                        ...
                        onBlur={async ev => {
                          ...
                          if (coordEl) {
                            const end = await geocodeReverso(coordEl[0], coordEl[1])
                            if (end) {
