  ...
  {form.metodoAvaliacao === 'evolutivo' && (
    <div className="rounded-xl border border-blue-200 bg-blue-50 p-4 space-y-2">
      ...
      <ul className="text-xs text-blue-700 list-disc list-inside space-y-1">
        <li><strong>CDDM Terreno</strong> — Homogeneização com 4 fatores: Área, Local, Topografia e Visibilidade</li>
        <li><strong>Benfeitorias</strong> — Cálculo depreciado pelo método CUB/R8N (VEIU)</li>
        <li><strong>Valor Final</strong> — Terreno + Benfeitorias (arredondado)</li>
      </ul>
      <p className="text-xs text-blue-600 opacity-75 pt-1">
        Os campos de Nota Local, Topografia e Visibilidade do avaliando são preenchidos diretamente na seção 10.
      </p>
    </div>
  )}
